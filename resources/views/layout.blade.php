                ...
                <div class="collapse navbar-collapse" id="halim">
                    <div class="menu-menu_1-container">
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            ...
                            <script type='text/javascript' src='{{asset('js/jquery.min.js?ver=3.6.0')}}'></script>
                            <script type='text/javascript'>
                            $(document).ready(function() {
                                // Disable links in dropdown menus
                            ...
                            <li class="mega dropdown">
                                <a title="Quoc gia" href="#" data-toggle="dropdown" class="dropdown-toggle"
                                    aria-haspopup="true">Quoc gia <span class="caret"></span></a>
                                <ul role="menu" class=" dropdown-menu">
